...
누군가는 한번쯤 필요한 상황이 있을 것 같아서 만든,
내가 파일 여러개 정리하다가 귀찮아서 만든,
파일 확장자 보기 토글 기능.
...
아주 간단하게 설치할 수 있습니다.
밑에 설명은 AI가 써준거라 보고싶은 사람만 봐도 됩니다.
다운받고 **Install.bat** 실행해서 설치.
...
다른 아이콘을 쓰려면 `icons/` 안의 `.ico` 두 개를 같은 이름으로 바꿔 넣고 `Install.bat` 을 다시 실행하십시오.
